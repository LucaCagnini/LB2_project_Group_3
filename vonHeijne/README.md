...
## **PSWM implementation** 
The script *create_pswm.ipynb* was produced to build a Position-Specific Weight Matrix (PSWM) from a training dataset of proteins with annotated signal peptides in the *train_bench.tsv* file.  The input DataFrame used must contain sequences and a SPEnd index for the cleavage site.
