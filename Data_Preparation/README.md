...
- [neg_cluster.tsv](aggiungilinkqandosalvatofile): TSV containing two colums ( ID of each sequence in th input file, ID of the representative sequence indetifying the cluster). 
- [neg_rep_seq.fasta]((aggiungilinkqandosalvatofile)): .fasta file containing all the representative sequences, one for each found cluster.
- [neg_all_seq.fasta]((aggiungilinkqandosalvatofile)): .fasta file with all the sequences used. 
